...
public class MainModel {
    ...
    public class CurrentWeather {
        private float temperature, windspeed, winddirection;
        private int weathercode, is_day;
        private String time;
...
//        }
    ...
    public class DailyUnits{
        private String time, weathercode;
        ...
        @Override
        public String toString() {
            return "DailyUnits{" + "time='" + time + '\'' + ", weathercode='" + weathercode + '\'' + '}';
        }
    }
    ...
    public class Daily{
        ...
        @Override
        public String toString() {
            return "Daily{" + "time= " + time + ", weathercode= " + weathercode + '}';
        }
    }
}
